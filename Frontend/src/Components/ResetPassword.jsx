...
const ResetPassword = () => {
  ...
  const verifyOTP = async () => {
    try {
      setMessage("");
      const res = await axios.post(
        "http://localhost:3000/forgetpassword/verifyotp",
        { emailId, otp },
        { withCredentials: true }
      );
      console.log(res);
  ...
  return (
    <>
     {showToast && <div className="w-1/2 md:w-fit bg-amber-300 text-white mx-auto my-2 p-1 px-2 rounded-lg fixed z-50 top-32  left-1/2 -translate-x-1/2 ">
