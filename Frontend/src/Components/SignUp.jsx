...
const SignUp = () => {
 ...
 try{
 const res=await axios.post(BASE_URL+"/signup",{firstName,lastName,emailId,password,gender},{withCredentials:true});
 setError("");
 ...
 navigate("/body/profile")
  ...
  style={{ backgroundImage: "url('https://png.pngtree.com/thumb_back/fh260/background/20240329/pngtree-three-friends-climbing-and-helping-each-other-to-reach-on-mountain-image_15697744.jpg')" }}
>
