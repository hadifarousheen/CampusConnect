        ...
        <div className="mx-auto w-full  md:w-1/2 mt-4 " >
            ...
            <div className="my-2 "> 
            {
                ...
                <div className=" bg-amber-100 flex justify-between my-2 p-1 px-2 py-2 rounded-lg shadow-2xl shadow-amber-950">
                    <div>
                    <h1 className="text-2xl font-bold">{connection.firstName}  {connection.lastName}</h1>
                    </div>
                    <button className="text-xl  mx-1 px-2 font-bold rounded-lg bg-amber-600 text-white" >Chat</button>
                </div>)
            }
            </div>
        </div>
